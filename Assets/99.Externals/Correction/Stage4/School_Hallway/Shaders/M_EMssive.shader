Shader "Unreal/M_Emissive"
{
	Properties
	{
		...
		Material_Texture2D_1( "T_Lamp_01_E", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,1.000000,0.000000);//UVTiling Normal Intensity B (Unknown)
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,1.000000,0.850000);//Desaturation Brightnes Metalic Roughness_Strength
	Material.ScalarExpressions[2] = float4(0.500000,0.000000,0.000000,0.000000);//AO_Strength (Unknown) (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Local0, 5);
	...
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, Local0, 4);
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 4);
	MaterialFloat3 Local13 = CustomExpression0(Parameters,Local11.rgb,Material.VectorExpressions[3].rgb);
	MaterialFloat Local14 = dot(Local13, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local15 = lerp(Local13,MaterialFloat3(Local14,Local14,Local14),MaterialFloat(Material.ScalarExpressions[1].x));
	MaterialFloat3 Local16 = (Local15 * Material.ScalarExpressions[1].y);
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, Local0, 2);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 2);
	MaterialFloat Local20 = (Material.ScalarExpressions[1].z * Local18.b);
	MaterialFloat Local21 = (Material.ScalarExpressions[1].w * Local18.g);
	MaterialFloat Local22 = (Local18.r * Material.ScalarExpressions[2].x);
