Shader "Unreal/M_Glass"
{
	Properties
	{
		...
		Material_Texture2D_0( "newhplaneNormalsMap", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.084527,0.163563,0.197917,0.000000);//Base Color
	Material.VectorExpressions[3] = float4(0.084527,0.163563,0.197917,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(100.000000,0.500000,0.000000,1.000000);//UV_T Flatness (S) (Unknown) Metallic
	Material.ScalarExpressions[1] = float4(0.200000,0.990000,0.000000,0.000000);//Opacity Refraction RefractionDepthBias (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[1].x;
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Material.ScalarExpressions[1].y,Material.ScalarExpressions[1].z);
