...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.180000,0.800000,0.000000,0.000000);//UVTiling Normal Intensity (Unknown) Desaturation
	Material.ScalarExpressions[1] = float4(1.300000,4.500000,0.000000,0.000000);//Brightnes Roughness_Strength (Unknown) (Unknown)
}
