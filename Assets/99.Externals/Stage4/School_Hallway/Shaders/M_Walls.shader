Shader "Unreal/MI_Walls"
{
	Properties
	{
		...
		Material_Texture2D_2( "T_Floor_R", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(10.000000,0.800000,0.000000,0.000000);//UVTiling Normal Intensity (Unknown) Desaturation
	Material.ScalarExpressions[1] = float4(0.600000,3.000000,0.000000,0.000000);//Brightnes Roughness_Strength (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, Local0, 4);
	...
	MaterialFloat3 Local16 = (Local14.rgb * Material.ScalarExpressions[1].y);
