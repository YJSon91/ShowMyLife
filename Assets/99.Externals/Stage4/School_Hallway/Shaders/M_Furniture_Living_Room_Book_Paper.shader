Shader "Unreal/MI_Furniture_Living_Room_Book_Paper"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.000000);//UVTiling Emissive_Strength (Unknown) BaseColorDesaturation
	Material.ScalarExpressions[1] = float4(0.500000,0.500000,0.000000,0.000000);//Roughness_Strength AO_Strength (Unknown) (Unknown)
}
