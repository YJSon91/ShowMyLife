...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,-0.500000,0.000000,0.200000);//UVTiling Normal Intensity (Unknown) Desaturation
	Material.ScalarExpressions[1] = float4(0.600000,1.000000,0.850000,0.500000);//Brightnes Metalic Roughness_Strength AO_Strength
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, Local0, 2);
