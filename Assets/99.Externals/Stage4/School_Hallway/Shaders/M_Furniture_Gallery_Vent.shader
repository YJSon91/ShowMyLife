Shader "Unreal/MI_Furniture_Gallery_Vent"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[5] = float4(0.255208,0.255208,0.255208,1.000000);//BaseColorLightness
	Material.VectorExpressions[6] = float4(0.255208,0.255208,0.255208,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.523810);//UVTiling Emissive_Strength (Unknown) BaseColorDesaturation
	Material.ScalarExpressions[1] = float4(2.869668,0.500000,0.000000,0.000000);//Roughness_Strength AO_Strength (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, Local0, 6);
	MaterialFloat4 Local5 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Local0,View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local8 = lerp(Local7,Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, Local0, 4);
	...
	MaterialFloat Local12 = dot(Local10.rgb, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local13 = lerp(Local10.rgb,MaterialFloat3(Local12,Local12,Local12),MaterialFloat(Material.ScalarExpressions[0].w));
	MaterialFloat3 Local14 = CustomExpression0(Parameters,Local13,Material.VectorExpressions[6].rgb);
	MaterialFloat3 Local15 = (Material.VectorExpressions[7].rgb * Local14);
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, Local0, 5);
	MaterialFloat4 Local17 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 5);
	MaterialFloat Local19 = (1.00000000 - Local17.r);
	MaterialFloat3 Local20 = lerp(Local15,Local14,MaterialFloat(Local19));
	MaterialFloat3 Local21 = (Material.VectorExpressions[8].rgb * Local20);
	MaterialFloat Local22 = (1.00000000 - Local17.g);
	MaterialFloat3 Local23 = lerp(Local21,Local20,MaterialFloat(Local22));
	MaterialFloat3 Local24 = (Material.VectorExpressions[9].rgb * Local23);
	MaterialFloat Local25 = (1.00000000 - Local17.b);
	MaterialFloat3 Local26 = lerp(Local24,Local23,MaterialFloat(Local25));
	MaterialFloat Local27 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local28 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4, Material_Texture2D_4Sampler,Local0,View.MaterialTextureMipBias));
	MaterialFloat Local29 = MaterialStoreTexSample(Parameters, Local28, 0);
	MaterialFloat Local30 = (Material.ScalarExpressions[1].x * Local28.g);
	MaterialFloat Local31 = (Material.ScalarExpressions[1].y * Local28.r);
