...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.500000);//UVTiling Normal Intensity (Unknown) Desaturation
	Material.ScalarExpressions[1] = float4(0.800000,1.000000,1.000000,0.500000);//Brightnes Metalic Roughness_Strength AO_Strength
}
